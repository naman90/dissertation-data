...
public class CsvWriter05 {
	...
	private static void generateCsvFile() {
		// Connection con=null;
		String sFileName = "C:\\Users\\Naman\\Dropbox\\dissertation\\ed-data\\processeddata\\07-0506\\merged05.csv";
		try {
			...
			String line = "";
			String files[] = {
					"C:\\Users\\Naman\\Dropbox\\dissertation\\ed-data\\processeddata\\07-0506\\ED2005"};
			...
			for (int i = 0; i <files.length; i++) {
				...
				while ((line = bufferedReader.readLine()) != null) {
					...
					// Visit Weight
					writer.append(line.substring(401,407).trim());
					writer.append(',');

					// region
					writer.append(line.charAt(407));
					writer.append(',');

					// hospital code
					writer.append(line.substring(413, 416).trim());
					writer.append(',');

					// hospital owner
					writer.append(line.charAt(409));
					writer.append(',');

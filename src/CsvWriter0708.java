...
public class CsvWriter0708 {
	...
	private static void generateCsvFile() {
		// Connection con=null;
		String sFileName = "C:\\Users\\Naman\\Dropbox\\dissertation\\ed-data\\processeddata\\08-070809\\merged0708.csv";
		try {
			...
			int count = 0;
			String line = "";
			String files[] = {"C:\\Users\\Naman\\Dropbox\\dissertation\\ed-data\\processeddata\\08-070809\\ED2007",
			"C:\\Users\\Naman\\Dropbox\\dissertation\\ed-data\\processeddata\\08-070809\\ED2008"		
			};
			...
			for (int i = 0; i <files.length; i++) {
				...
				while ((line = bufferedReader.readLine()) != null) {
					...
					// Visit Weight
					writer.append(line.substring(374,380).trim());
					writer.append(',');

					// region
					writer.append(line.charAt(380));
					writer.append(',');

					// hospital code
					writer.append(line.substring(388,390).trim());
					writer.append(',');

					// hospital owner
					writer.append(line.charAt(382));
					writer.append(',');
